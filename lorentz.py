...
GLUON4 = Lorentz(name = 'GLUON4',
                spins = [ 1, 1, 1, 1 ],
                structure = '1')

GLUON5 = Lorentz(name = 'GLUON5',
                spins = [ 1, 1, 1, 1, 1 ],
                structure = '1')

GLUON6 = Lorentz(name = 'GLUON6',
                spins = [ 1, 1, 1, 1, 1, 1 ],
                structure = '1')

GLUON7 = Lorentz(name = 'GLUON7',
                spins = [ 1, 1, 1, 1, 1, 1, 1 ],
                structure = '1')

GLUON8 = Lorentz(name = 'GLUON8',
                spins = [ 1, 1, 1, 1, 1, 1, 1, 1 ],
                structure = '1')

GLUON9 = Lorentz(name = 'GLUON9',
                spins = [ 1, 1, 1, 1, 1, 1, 1, 1, 1 ],
                structure = '1')

GLUON10 = Lorentz(name = 'GLUON10',
                spins = [ 1, 1, 1, 1, 1, 1, 1, 1, 1 ],
                structure = '1')
